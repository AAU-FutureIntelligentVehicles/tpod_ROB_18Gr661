...
def single_img_features(img, color_space='RGB', spatial_size=(32, 32),
                        ...
                        spatial_feat=spatial_feat, hist_feat=hist_feat, hog_feat=hog_feat, hog_features=None):    
    img_features = []
    ...
    if haralick_feat == True:

        haralick_features = mahotas.features.haralick(feature_image)
        
        harafeat_list = [item for sublist in haralick_features for item in sublist]


        img_features.append(harafeat_list)
